...
```{r}
# stress <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
# wlb <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
aut_vs_sel <- import_cols("SHP15_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS/W17_2015",
...
```{r}
# sleep_problems <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
# work_conditions <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
# standard_of_living <- import_long_cols("H_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
# child_care <- import_long_cols("H_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
...
```{r}
# interference <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS",
#                          cols = c("IDPERS", "PYYF50"), year_start = "2004", year_end = "2018")
...
age <- import_cols("SHP10_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS/W12_2010",
                   cols = c("IDPERS", "AGE10"))
names(age)[1] <- "ID"
data <- left_join(data, age)

gender <- import_cols("SHP10_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS/W12_2010",
                      cols = c("IDPERS", "SEX10"))
names(gender)[1] <- "ID"
...
explaining_variables <- import_cols("SHP08_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W20-SPSS/W10_2008",
