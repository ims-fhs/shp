...
# library(kml)
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC71"), year_start = "2012", year_end = "2014")
...
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC75"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC106"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC108"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXW604"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXW93"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXW94"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXW228"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXF51"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXF52"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC111"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
...
#
#
# data <- import_long_cols("P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W19-SPSS", cols = c("IDPERS", "PXXC115"), year_start = "2004", year_end = "2017")
# data <- data %>% filter(complete.cases(.))
#
