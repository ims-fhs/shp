...
# library(kml)
#
# head <- import_SPSS_file_head("SHP04_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W21-SPSS/W6_2004")
#
...
#
# age <- import_cols("SHP10_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W21-SPSS/W12_2010", cols = c("IDPERS", "AGE10"))
# names(age)[1] <- "ID"
# data <- left_join(data, age)
#
# gender <- import_cols("SHP10_P_USER.sav", "data/rawdata/Data SPSS/SHP-Data-W1-W21-SPSS/W12_2010", cols = c("IDPERS", "SEX10"))
# names(gender)[1] <- "ID"
